...
### This guide follows the [tutorial](youtube.com) I made, although if you're not into hearing people talk use this. You will need to use this for the tutorial either way to download the appropriate files.

**All of the files are from trusted sources and are scanned for viruses beforehand.**
